...
def paired_random_crop(img_lqs, img_gts, gt_patch_size, scale, gt_path):
    """Paired random crop.
    for super resolution, input 1.png, 1x4.png, crop them into gt_patch_size, gt_patch_size//scale
